...
<form role="search" method="get" class="search-form"
	...
	aria-label="<?php echo esc_attr__( 'Sökformulär', 'knowit-starter-theme' ); ?>">

	<div class="input-group">
		<label for="search-field" class="screen-reader-text">
			<?php echo esc_html__( 'Sök efter:', 'knowit-starter-theme' ); ?>
		</label>
		...
		<input
			...
			placeholder="<?php echo esc_attr_x( 'Sök …', 'placeholder', 'knowit-starter-theme' ); ?>"
		...
		knowit_button(
			array(
				'label'   => __( 'Sök', 'knowit-starter-theme' ),
				'variant' => 'secondary',
				'type'    => 'submit',
