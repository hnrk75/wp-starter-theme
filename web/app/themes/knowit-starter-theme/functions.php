...
if ( ! function_exists( 'knowit_setup' ) ) :
	function knowit_setup() {
		...
		// Översättningar
		load_theme_textdomain( 'knowit-starter-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'main-menu' => __( 'Huvudmeny', 'knowit-starter-theme' ),
			)
		);
...
add_action( 'wp_head', 'knowit_add_favicon' );

if ( ! function_exists( 'knowit_register_navwalker' ) ) :
	function knowit_register_navwalker() {
...
add_action( 'after_setup_theme', 'knowit_register_navwalker' );
