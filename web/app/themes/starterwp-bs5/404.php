				...
				<section class="error-404 not-found">
					...
					<div class="page-content">
						...
						<?php get_search_form();
							...
							if ( starterwp_categorized_blog() ) :
						?>

						<div class="widget widget_categories">
							<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'starterwp-textdomain' ); ?></h2>
							<ul>
							<?php
						...
						<?php endif;
							$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'starterwp-textdomain' ), convert_smilies( ':)' ) ) . '</p>';
